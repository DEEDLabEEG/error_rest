% ********************************************************************** %
% Title: Preprocessing Script for Go/No-Go Data [Script 1]
% Authors: Armen Bagdasarov & Kenneth Roberts
% Institution: Duke University
% ********************************************************************** %

%% Script Description
% This script prepares MATLAB to process Go/No-Go data. It loops through
% all subjects and calls the go_process_single_subject.m script, which 
...
%% Loop Over Subjects and Run go_process_single_subject.m Script
